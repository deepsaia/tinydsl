...
class GlintDSLTool:
    ...
    def run_example(self, example_id: str, save: bool = True, open_after_save: bool = False):
    ...
    def run_code(self, code: str, name: Optional[str] = "agent_run", save: bool = True, open_after_save: bool = False):
